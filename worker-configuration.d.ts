/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6188063665c6b20e2a0ed597afc0979b)
...
interface __BaseEnv_Env {
	...
	SUPABASE_DB_POOL_URL: string;
	SUPABASE_SERVICE_ROLE_KEY: string;
	LEAD_PII_ENC_KEY: string;
	AUDIT_HMAC_KEY: string;
	NOTIFY_LEAD_SECRET: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_SITE_URL" | "PUBLIC_SUPABASE_URL" | "PUBLIC_SUPABASE_ANON_KEY" | "AI_DAILY_USD_CAP" | "SUPABASE_DB_POOL_URL" | "SUPABASE_SERVICE_ROLE_KEY" | "LEAD_PII_ENC_KEY" | "AUDIT_HMAC_KEY" | "NOTIFY_LEAD_SECRET">> {}
}
